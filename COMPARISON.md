...
| Aspect | Waterfall | Agile | Scrum | DevOps | Context Mesh |
|--------|-----------|-------|-------|--------|-----|
...
- **Context Mesh**: Context is primary, evolves continuously, integrated with code

### When to Use
- **Waterfall**: Highly regulated industries, fixed requirements
- **Context Mesh**: AI-First development, evolving requirements, context-critical projects

## Context Mesh vs Agile
...
- **Context Mesh**: Context is primary, code is manifestation
- **Agile**: Documentation is important but secondary
- **Context Mesh**: Context preservation is fundamental

### Compatibility
Context Mesh is **compatible with Agile**. Context Mesh adds context preservation to Agile practices. You can use Context Mesh within an Agile approach.

### When to Use
- **Agile**: General software development, iterative projects
- **Context Mesh**: AI-First development, context-critical projects, teams using AI tools extensively

## Context Mesh vs Scrum
...
- **Context Mesh**: Context preservation and AI-First practices
- **Scrum**: Backlog and documentation support development
- **Context Mesh**: Context drives development
- **Scrum**: 5 events
- **Context Mesh**: 3 steps (simpler)

### Compatibility
Context Mesh is **compatible with Scrum**. Context Mesh can be integrated into Scrum events:
...
- **Context Mesh**: AI-First development, context preservation, teams using AI tools

## Context Mesh vs DevOps
...
- **Context Mesh**: Focus on context preservation and AI-First development
- **DevOps**: Automation and infrastructure
- **Context Mesh**: Context and knowledge management

### Compatibility
Context Mesh is **compatible with DevOps**. Context Mesh integrates with DevOps practices:
- Plan → Step 1 (Intent)
...
- **Context Mesh**: Context preservation, AI-First development, knowledge management

## Context Mesh vs PaellaDoc
...
- **Context Mesh**: Framework-focused, workflow-based
- **PaellaDoc**: Specific tool integration (Cursor, MCP)
- **Context Mesh**: Tool-agnostic, flexible integration

### Compatibility
Context Mesh and PaellaDoc are **compatible**. PaellaDoc's documentation templates can be used within Context Mesh's workflow. They share the same philosophical foundation (5 AI-First principles).

### When to Use
- **PaellaDoc**: Documentation structure, Cursor AI integration
- **Context Mesh**: Complete framework, context preservation, full lifecycle

## Context Mesh vs Traditional Documentation
...
- **Context Mesh**: Context is integrated, living, preserves why and how
- **Traditional**: Documentation is secondary
- **Context Mesh**: Context is primary

## Choosing the Right Framework

### Use Context Mesh When:
...
- ✅ You can add Context Mesh for context preservation

## Combining Frameworks

### Context Mesh + Scrum (Recommended)
- Scrum provides team structure
- Context Mesh adds context preservation
...
- Context Mesh adds context to pipeline
...
| **Context Mesh** | 3 steps | Low | Fast | 1-2 weeks |
| **Agile** | N/A | Low | Fast | Ongoing |
| **DevOps** | N/A | Medium | Medium | 1-3 months |
| **Waterfall** | 5-7 phases | Medium | Medium | 1-2 months |

**Key Insight**: Context Mesh is designed to be as simple as Scrum, with only 3 steps instead of 5 events, making it easy to learn and adopt.

## Further Reading

- [FRAMEWORK.md](FRAMEWORK.md) - Context Mesh framework details
- [INTEGRATION.md](INTEGRATION.md) - Integration guides
- [PRINCIPLES.md](PRINCIPLES.md) - Context Mesh principles
